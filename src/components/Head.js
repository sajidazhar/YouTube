  ...
  return (
    ...
    <div>
        <input
         ...
         />
        <button className="border border-gray-400 px-5 py-2 rounded-r-full bg-gray-100 absolute">🔍</button>
    </div>
    {showSuggestions && (<div className="fixed bg-white py-2 px-2 w-[27rem] shadow-lg rounded-lg border border-gray-100 absolute">
        <ul>
        {suggestions.map(s => 
